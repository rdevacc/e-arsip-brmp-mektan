...
@section('title')
    Roles Arsip | E-Arsip BRMP Mektan
@endsection
                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('role.edit-submit', $role->id) }}">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                ...
                                <div class="mt-5 mb-2 me-2 text-end">
                                    <button type="button" class="btn btn-secondary" onclick="window.location.href='{{ route('role.index') }}'">Kembali</button>
