                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="pt-2 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">Masukan Password Baru Untuk Akun Anda</h5>
                                    </div>
                                    <form class="row g-3" action="{{ route('password.update') }}" method="POST">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group">
                                                <input type="email" name="email" class="form-control bg-body-secondary @error('email') is-invalid @enderror" id="email" value="{{ $email ?? old('email') }}" readonly required>
                                            @error('email')
                                        ...
                                        <div class="col-12">
                                            <button id="resetButton" class="btn btn-primary w-100" type="submit">
                                                <span id="buttonText">Kirim Reset Link</span>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                form.addEventListener("submit", function() {
                    ...
                    // Ubah teks tombol jadi "Mengirim..."
