        ...
        <section class="section">
            <div class="row">
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Edit Data Unit Kerja</h5>
                            ...
                            <form method="POST" action="{{ route('work-unit.edit-submit', $work_unit->id) }}">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-12 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            id="name" name="name" value="{{ $work_unit->name ?:old('name') }}">
                                        @error('name')
                                ...
                                <div class="mt-5 mb-2 me-2 text-end">
                                    <button type="button" class="btn btn-secondary" onclick="window.location.href='{{ route('work-unit.index') }}'">Kembali</button>
