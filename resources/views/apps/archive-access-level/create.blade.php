...
@section('title')
    Level Akses Arsip | E-Arsip BRMP Mektan
@endsection
        ...
        <section class="section">
            <div class="row">
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Tambah Data Level Akses Arsip</h5>
                            ...
                            <form method="POST" action="{{ route('archive-access-level.create-submit') }}">
                                @csrf
                                <div class="row">
