        ...
        <section class="section">
            <div class="row">
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Edit Data Retensi Arsip</h5>
                            ...
                            <form method="POST" action="{{ route('archive-retention.edit-submit', $archive_retention->id) }}">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-12 mb-3">
                                        ...
                                        <input type="number" class="form-control no-spinner @error('range_value') is-invalid @enderror"
                                            id="range_value" name="range_value" value="{{ $archive_retention->range_value ? $archive_retention->range_value : old('range_value') }}">
                                        @error('range_value')
