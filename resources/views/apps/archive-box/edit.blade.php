        ...
        <section class="section">
            <div class="row">
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Edit Data Box Arsip</h5>
                            ...
                            <form method="POST" action="{{ route('archive-box.edit-submit', $archive_box->id) }}">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            id="name" name="name" value="{{ $archive_box->name ?:old('name') }}">
                                        @error('name')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
