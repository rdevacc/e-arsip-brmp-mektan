        ...
        <section class="section">
            <div class="row">
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Edit Data Folder Arsip</h5>
                            ...
                            <form method="POST" action="{{ route('archive-folder.edit-submit', $archive_folder->id) }}">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-12 mb-3">
                                        ...
                                        <select name="archive_box_id" id="archive_box_id"
                                            ...
                                            @foreach ($archiveBoxes as $archiveBox)
                                                <option value="{{ $archiveBox->id }}"
                                                    {{ old('archive_box_id', $archive_folder->archive_box_id) == $archiveBox->id ? 'selected' : '' }}>
                                                    {{ $archiveBox->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            id="name" name="name" value="{{ $archive_folder->name ?:old('name') }}">
                                        @error('name')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
